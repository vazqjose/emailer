    ...
    <div class="col-md-9" name="maincontent" id="maincontent">
		...
		<div class="panel-heading"><h5>Email's Manager</h5></div>
			...
			<!-- ***********Edit your content STARTS from here******** -->
				...
				Search client to update/delete record<br>
				<form class="form-inline" role="form" name="" action="" method="GET">
					<div class="form-group">
					  <input class="form-control" name="staffname" type="text" placeholder="Email or Name...">
				...
				?>
					<tr>
						...
						?>
						<a href="<?php echo $urlupdate?>" class="btn btn-warning" title="Update client record" 
						data-toggle="tooltip" > 
						<span class="fui-new"></span></a>
						<a href="#" class="btn btn-danger" title="Delete client record!" 
						data-toggle="tooltip" onclick="alertdelete()"> 
						<script>
							//script to redirect delete page
							function alertdelete() {
								var r = confirm("You really want to delete the Client?");
								if (r == true) {
